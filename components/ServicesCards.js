...
const cards = [
    {
        ...
        icon: <FaPenNib />,
        imageClass: "w-[100px] h-[180px] md:w-[160px] md:h-[240px] right-4 top-5", // lebih kecil
    },
    {
        title: "Content\nCreation",
        ...
        imageClass: "w-[140px] h-[220px] md:w-[200px] md:h-[260px] -right-4 -top-8",
    },
    {
        title: "Strategy &\nCampaign",
        ...
        imageClass: "w-[140px] h-[220px] md:w-[200px] md:h-[260px] right-2 top-0 md:top-2",
    },
    {
        title: "KOL\nSpecialist",
        ...
        imageClass: "w-[130px] h-[210px] md:w-[180px] md:h-[260px] right-2 top-2",
    },
];
...
export default function ServicesCards() {
    return (
        <section className="w-full px-8 py-10 bg-[#efefef]">
            <div className="grid grid-rows-1 md:grid-cols-4 gap-6 md:gap-8">
                {cards.map((card, i) => (
                    <div
                        key={i}
                        className="group relative shadow-lg/10 flex flex-col justify-between bg-[#ededed] border-1 border-[#d1d1d1] rounded-2xl p-6 h-[220px] md:h-[280px] overflow-visible transition-all duration-500 hover:-translate-y-1 hover:shadow-2xl"
                    >
                        {/* Icon */}
                        ...
                        {/* Title + desc */}
                        <div className="mt-2.5 md:mt-4 flex-1">
                            <h3 className="text-[20px] md:text-[26px] font-semibold leading-[1.1] tracking-normal md:tracking-[-1px] whitespace-pre-line text-black">
                                {card.title}
                            </h3>
                            <p className="mt-1.5 md:mt-3 text-[11px] md:text-[13px] leading-relaxed text-black/55 max-w-[170px]">
                                {card.desc}
                            </p>
                        </div>
